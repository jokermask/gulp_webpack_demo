...
exports['find'] = {
  ...
  'basic matching': function(test) {
    ...
    test.deepEqual(globule.find('**/*.js', '**/*.css'),
      ['js/bar.js', 'js/foo.js', 'scss/baz.css', 'scss/qux.css'],
  ...
  'file order': function(test) {
    ...
    var expected = ['scss/baz.css', 'scss/qux.css', 'js/bar.js', 'js/foo.js'];
    ...
    expected = ['js/foo.js', 'js/bar.js', 'scss/baz.css', 'scss/qux.css'];
    ...
    expected = ['js/bar.js', 'js/foo.js', 'scss/baz.css', 'scss/qux.css'];
    test.deepEqual(actual, expected, 'specifically-specified-up-front file order should be maintained.');

    actual = globule.find('**/*.{js,scss}', '!scss/qux.css', 'scss/qux.css');
    expected = ['scss/baz.css', 'js/bar.js', 'js/foo.js', 'scss/qux.css'];
    test.deepEqual(actual, expected, 'if a file is excluded and then re-added, it should be added at the end.');

    actual = globule.find('js/foo.js', '**/*.{js,scss}', '!scss/qux.css', 'scss/qux.css');
    expected = ['js/foo.js', 'scss/baz.css', 'js/bar.js', 'scss/qux.css'];
  ...
  'exclusion': function(test) {
    ...
    test.deepEqual(globule.find(['!js/foo.js', '**/*.js']),
      ['js/bar.js', 'js/foo.js'],
      'inclusion / exclusion order matters');
    test.deepEqual(globule.find(['**/*.js', '**/*.css', '!js/bar.js', '!scss/baz.css']),
      ['js/foo.js','scss/qux.css'],
    ...
    test.deepEqual(globule.find(['js/bar.js', 'js/foo.js', 'scss/baz.css', 'scss/qux.css', '!**/b*.*']),
      ['js/foo.js', 'scss/qux.css'],
      'different pattern for exclusion should still work');
    test.deepEqual(globule.find(['js/bar.js', '!**/b*.*', 'js/foo.js', 'scss/baz.css', 'scss/qux.css']),
      ['js/foo.js', 'scss/baz.css', 'scss/qux.css'],
      'inclusion / exclusion order matters');
    test.done();
  },
